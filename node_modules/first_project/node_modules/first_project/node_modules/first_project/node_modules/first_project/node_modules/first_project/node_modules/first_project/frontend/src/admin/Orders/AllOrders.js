...
const AllOrders = () => {
  ...
  return (
    <div className="w-full p-6 mx-auto rounded-lg shadow-lg bg-white-200">
      <h1 className="mb-4 text-xl font-semibold">Admin - Orders Management</h1>
      ...
      {orders.length > 0 ? (
        <table className="w-full overflow-hidden bg-white rounded-lg shadow-md">
          <thead className="bg-gray-200">
            <tr>
              <th className="px-4 py-2 text-sm">Customer</th>
              <th className="px-4 py-2 text-sm">Products</th>
            ...
            {orders.map((order) => (
              <tr key={order._id} className="border-b">
                ...
                <td className="px-4 py-2">
                  <button onClick={() => handleEditOrder(order)} className="px-4 py-2 mr-2 text-sm text-white bg-yellow-500 rounded">Edit Status</button>
                  <button onClick={() => handleDeleteOrder(order._id)} className="px-4 py-2 text-sm text-white bg-red-500 rounded">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
